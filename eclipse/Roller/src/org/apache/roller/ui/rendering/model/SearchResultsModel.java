...
public class SearchResultsModel extends PageModel {
    ...
    public String getTermHtmlEncoded() {
    	Encoder e = ESAPI.encoder();
        return (searchRequest.getQuery() == null) ? "" : e.encodeForHTMLAttribute( searchRequest.getQuery() );
    }
    
    public String getTermUrlEncoded() throws RollerException {
    	Encoder e = ESAPI.encoder();
    	String s = null; 
    		
    	try {
    		s = e.encodeForURL( searchRequest.getQuery() );
    	} catch (EncodingException ex) {
    		throw new RollerException(ex);
    	}
        return (searchRequest.getQuery() == null) ? "" : s;
    }
